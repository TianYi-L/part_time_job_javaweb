...
public class MenuController {
    ...
    public Map<String, Object> indexLeftMenuJson(HttpSession session) {
        ...
        menus.add(new Menu(1, "常规管理", "", "", "_self", 0, 1, 1, null, null));
        menus.add(new Menu(12, "系统管理", "", "/admin/role/toRoleManager", "_self", 1, 1, 1, null, null));
        menus.add(new Menu(20, "菜单管理", "", "/admin/menu/toMenuManager", "_self", 12, 1, 1, null, null));
        menus.add(new Menu(21, "用户管理", "", "/admin/user/toUserManager", "_self", 12, 1, 1, null, null));
        menus.add(new Menu(22, "角色管理", "", "/admin/role/toRoleManager", "_self", 12, 1, 1, null, null));
        menus.add(new Menu(23, "商家审核", "", "/admin/userIdCard/toUserIdCardManager", "_self", 12, 1, 1, null, null));
        menus.add(new Menu(24, "工作审核", "", "/admin/job/toJobManager", "_self", 12, 1, 1, null, null));
        // homeInfo
